...
git submodule add https://github.com/SergioRando/js-locale.git
```
...
```
cd {Project Path}/src/lib
git submodule deinit js-locale
git rm js-locale
git commit -m "Removed submodule js-locale"
cd {Project Path}
rm -rf ./git/modules/src/lib/js-locale
```
